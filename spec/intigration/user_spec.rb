...
describe "NewTest" do
  ...
  it "test_incorrect_data_entry_when_logging_in" do
    ...
    @driver.find_element(:name, "user[email]").send_keys "user2@mail.ru"
    ...
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='Automorphic numbers'])[1]/preceding::p[1]").click
  end
  ...
  it "test_incorrect_data_entry_during_registration" do
    ...
    @driver.find_element(:id, "user_email").send_keys "user2@mail.ru"
  ...
  it "test_correct_log_in_and_out" do
    ...
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)=concat('', '\"', 'Welcome ', '\"', 'user1@mail.ru')])[1]/following::button[1]").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='Sign Up'])[1]/following::h2[1]").click
  end
  ...
  it "test_updating_data" do
    ...
    @driver.find_element(:name, "user[password]").send_keys "123456"
    @driver.find_element(:id, "new_user").submit
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='See all users'])[1]/following::button[1]").click
    @driver.find_element(:id, "user_password").click
    @driver.find_element(:id, "user_password").clear
    @driver.find_element(:id, "user_password").send_keys "123456"
    @driver.find_element(:id, "user_password_confirmation").click
    ...
    @driver.find_element(:name, "commit").click
    @driver.find_element(:xpath, "//*/text()[normalize-space(.)='Your account has been updated successfully.']/parent::*").click
  end
  ...
  it "test_see_all_users_and_your_profile" do
    ...
    @driver.find_element(:name, "user[password]").send_keys "123456"
    @driver.find_element(:name, "commit").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='Log out'])[1]/following::button[1]").click
    @driver.find_element(:xpath, "//*/text()[normalize-space(.)='All users:']/parent::*").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='Show profile'])[1]/following::button[1]").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='Edit profile'])[1]/following::button[1]").click
    @driver.find_element(:xpath, "//*/text()[normalize-space(.)='Information about profile:']/parent::*").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='updated at'])[1]/following::button[1]").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)=concat('', '\"', 'Welcome ', '\"', 'user1@mail.ru')])[1]/following::button[1]").click
  end
  ...
  it "test_new" do
    ...
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='N^2'])[1]/following::td[9]").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='N^2'])[1]/following::td[10]").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='N^2'])[1]/following::button[1]").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)=concat('', '\"', 'Welcome ', '\"', 'user1@mail.ru')])[1]/following::button[1]").click
  end
  ...
  it "test_new" do
    ...
    @driver.find_element(:id, "user_password_confirmation").send_keys "123456"
    @driver.find_element(:name, "commit").click
    @driver.find_element(:xpath, "//*/text()[normalize-space(.)='Welcome! You have signed up successfully.']/parent::*").click
    @driver.find_element(:id, "num").click
    @driver.find_element(:id, "num").clear
    @driver.find_element(:id, "num").send_keys "10"
    @driver.find_element(:id, "num").send_keys :enter
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='N^2'])[1]/following::td[5]").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='N^2'])[1]/following::td[6]").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='N^2'])[1]/following::button[1]").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='See all users'])[1]/following::button[1]").click
    @driver.find_element(:xpath, "(.//*[normalize-space(text()) and normalize-space(.)='Cancel my account'])[1]/following::button[1]").click
  end
